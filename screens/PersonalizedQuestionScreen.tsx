...
export default function PersonalizedQuestionScreen({ navigation }: PersonalizedQuestionScreenProps) {
    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 400) {
          ...
          toast.error(responseData.message || 'Error al guardar la respuesta');
        }
        return;
      }      toast.success('¡Respuesta registrada exitosamente!');
      
      // Navegar a la siguiente pantalla (Pantalla 10 - Tipo de historias)
      navigation.navigate('StoryTypesQuestion');
        ...
        <View style={styles.header}>
          ...
          <View style={styles.speechBubble}>
            <Text style={styles.speechText}>
              <Text style={styles.speechBold}>¿Qué{'\n'}actividad{'\n'}disfruta</Text> más{'\n'}tu <Text style={styles.speechBold}>hijo?</Text>
            </Text>
        ...
        <View style={styles.optionsContainer}>
          {activityOptions.map((activity, index) => (
            <TouchableOpacity
              ...
              style={[
                styles.optionButton,
                selectedActivity === activity && styles.optionButtonSelected
              ]}
